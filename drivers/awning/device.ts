...
module.exports = class AwningDevice extends Homey.Device {
   ...
   */
  async onInit() {
    this.log('Velux Awning has been initialized');
   ...
   */
  async onAdded() {
    this.log('Velux Awning has been added');
  }
  ...
  async onSettings({
    ...
    this.log('Velux Awning settings where changed');
  }
  ...
  async onRenamed(name: string) {
    this.log('Velux Awning was renamed');
  }
   ...
   */
  async onDeleted() {
    this.log('Velux Awning has been deleted');
  }
