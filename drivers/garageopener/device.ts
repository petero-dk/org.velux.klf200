...
module.exports = class GarageOpenerDevice extends Homey.Device {
   ...
   */
  async onInit() {
    this.log('Velux GarageOpener has been initialized');
   ...
   */
  async onAdded() {
    this.log('Velux GarageOpener has been added');
  }
  ...
  async onSettings({
    ...
    this.log('Velux GarageOpener settings where changed');
  }
  ...
  async onRenamed(name: string) {
    this.log('Velux GarageOpener was renamed');
  }
   ...
   */
  async onDeleted() {
    this.log('Velux GarageOpener has been deleted');
  }
