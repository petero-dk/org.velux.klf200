...
module.exports = class RollerShutterDriver extends Homey.Driver {
  ...
  async onPairListDevices() {
    this.log('RollerShutter onPairListDevices called');
    ...
    return (veluxHandler as any)['products'].Products.filter((product: Product) => product.TypeID === ActuatorType.RollerShutter).map((product: Product) => ({
      name: product.Name,
      data: {
        id: product.NodeID,
      },
